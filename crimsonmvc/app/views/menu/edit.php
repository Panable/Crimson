...
<!--
            <div class="row">
                    ...
                    <label for="">
                        <input id="menu-input" type="text" readonly="readonly" placeholder="ID"
                               class="form-control">


                        Add this if required in column <span
                ...
                <div class="col">
                    ...
                    <label for="">
                        <input id="menu-input" type="text" placeholder="Name" class="form-control">
                        Add this if required in column <span
                                class="material-symbols-outlined"> more_horiz </span>
                    </label>
                </div>
                ...
                <div class="col">
                    ...
                    <label for="">
                        <input id="menu-input" type="text" placeholder="Price" class="form-control">
                    </label>
                </div>
                    ...
                    <label for="">
                        <input id="menu-input" type="text" placeholder="Description" class="form-control">
                    </label>
                </div>
