...
function buildItemWithQuantity($quantityHtml, $img_source, $name_source, $price_source, $description_source)
{
    ...
    $image = '<div class="rounded-3 my-5 mt-n4">
    ...
    $card = '<div class="col-md-4 my-3">
                <div class="card border-0 w-75 h-25">
